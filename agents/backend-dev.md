...
transform:
  ...
  gemini: section
  codex: section
skills: [oop-principles, spring-boot-conventions, java-style, kotlin-style, layered-architecture, java-testing, kotlin-testing, implementation-doc, implementation-checkpoint]
---
