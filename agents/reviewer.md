...
transform:
  ...
  gemini: section
  codex: section
skills: [general-style, oop-principles, layered-architecture, spring-boot-conventions, java-style, kotlin-style, java-testing, kotlin-testing, design-doc, implementation-doc, api-verification, git-conventions]
---
